...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_PAINT:
	{
		...
		StClausAuto(hdc,0,0);
		StClausAuto(hdc, 40, 80);
		StClausAuto(hdc, 80, 160);
		StClausAuto(hdc, 120, 240);
		StClausAuto(hdc, 160, 340);
		StClausAuto(hdc, 200, 420);
		StClausAuto(hdc, 240, 500);
		StClausAuto(hdc, 280, 580);
