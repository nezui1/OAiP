...
void printElementsfile() {
	int i = 0;
	FILE *fin;
	fin = fopen("C:\\Users\\Макс\\source\\repos\\Laba18(1)\\input.txt", "rt");
	if (fin == NULL) {
...
void saveArrInFail(){
	int i = 0;
	FILE *fout;
	fout = fopen("C:\\Users\\Макс\\source\\repos\\Laba18(1)\\output.txt", "wt");
	if (fout == NULL) {
...
void main() {
	...
	do {
		...
		printf("16: Ввести массив при помощи файла\n");
		...
		printf("17: сохранить массив в файле\n");
		printf("\n");
